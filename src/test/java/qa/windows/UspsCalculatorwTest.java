...
public class UspsCalculatorwTest extends MasterBase {


	public UspsCalculatorwTest() throws Exception {
		//super();
	...
	@Test(description = "Type1:Home Depot box Small - (16 in. L x 12 in. W x 12 in. D)")
	public void uspsCalTest1() throws Exception {
		 ...
		 */
			...
			/*	
			 * Select the Destination zip code 
			 */
			...
			/*	
			 * Select package option  ground Delivery
			 */
			uspPage.clickbox();
